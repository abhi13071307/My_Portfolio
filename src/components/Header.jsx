        ...
        <div className="sm:hidden border-t border-slate-800 bg-slate-900/75">
          <div className="px-4 py-3 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a href="https://linkedin.com/in/abhishek1307" target="_blank" rel="noreferrer" className="py-2">LinkedIn</a>
              <Link to="/resume" onClick={() => setOpen(false)} className="btn-coral">Resume</Link>
            </div>
          </div>
        </div>
      )}
